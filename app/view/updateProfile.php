<div tabindex="0" aria-label="form" class="focus:outline-none w-full bg-white p-10">
  ...
  <button role="button" aria-label="Next step" class="flex items-center justify-center py-2 px-7 focus:outline-none bg-white border rounded border-gray-400 mt-7 md:mt-10 hover:bg-gray-100  focus:ring-2 focus:ring-offset-2 focus:ring-gray-700">
