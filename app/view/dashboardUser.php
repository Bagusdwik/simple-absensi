  ...
  <div class="flex w-full flex-wrap items-center justify-between px-6">
    ...
    <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto" id="navbarSupportedContent1" data-te-collapse-item>
      ...
      <ul class="list-style-none mr-auto flex flex-col pl-0 lg:flex-row" data-te-navbar-nav-ref>
        ...
        <li class="lg:pr-2" data-te-nav-item-ref>
          <a class="text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400" href="#" data-te-nav-link-ref><?= $model['User'] ?? '' ?></a>
        </li>
      </ul>
      <!-- Left links -->
    </div>
...
<div class="flex justify-center">
  ...
  <div class="block max-w-sm text-center rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-700">
    ...
    <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
      Absensi akan terhitung setiap anda mengklik tombol di bawah dan Pakta Integritas bisa anda submit kapanpun.
    </p>
